...
/**Checks if user is logged in for api calls
 * @param {Request} req
 * @param {Response} res
 * @param {Next Middleware} next
 */
export function isLoggedIntoAPI(req, res, next) {
...
/** Checks if the route has data passed in, this can be restructured to any format as needed
 * @param {Request} req
 * @param {Response} res
 * @param {Next Middleware} next
 */
